#!/bin/bash
# Final script to fix server - uses SSH_PASSPHRASE env var if set

SSH_KEY="/Users/josiahknoedler/Desktop/Projects/id_ed25519"
SERVER="root@129.212.186.215"

# Check if passphrase is in env, otherwise prompt
if [ -z "$SSH_PASSPHRASE" ]; then
    echo "Enter SSH key passphrase (or set SSH_PASSPHRASE env var):"
